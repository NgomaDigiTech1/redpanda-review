...
class CommonModel extends Model
{
    ...
    public function getDistinct(string $collection, $fields)
    {
        return $this->m->myDistinct($collection, $fields);
    }

    public function myLikeFunction(string $collection, string $field, $value, $flags){

        return $this->m->like($field, $value, $flags, true, TRUE)->find($collection)->toArray();
    }
}
