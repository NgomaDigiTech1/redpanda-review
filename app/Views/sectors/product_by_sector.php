                                    ...
                                    <tr>
                                        <td style="padding: 8px">
                                            ...
                                            <?php if (isset($item->product_slug) && ($item->product_slug === 'home-insurance')) : ?>
                                                ...
                                                <a href="<?= base_url() ?>/load-home/<?= $item->product_slug; ?>">
                                                    ...
                                                    <img src="<?= base_url() ?>/assets/rp_admin/images/product/<?= $item['product_image']; ?>" alt="img" style="width: 180px;height: 120px" class="img-fluid" />
                                                <?php elseif (isset($item->product_slug) && ($item->product_slug === 'car-insurance')) : ?>

                                                    <a href="<?= base_url() ?>/load-car/<?= $item->product_slug; ?>">
                                                        <img src="<?= base_url() ?>/assets/rp_admin/images/product/<?= $item['product_image']; ?>" alt="product-image" style="width: 180px;height: 120px" class="img-fluid">
                                                    </a>

                                                <?php else : ?>

                                                    <a href="<?= base_url() ?>/load-request/<?= $item->product_slug; ?>">
                                                        <img src="<?= base_url() . "./assets/rp_admin/images/product/" . $item['product_image']; ?>" alt="<?= $item->product_name; ?>" style="width: 180px;height: 120px" class="img-fluid">
                                                    </a>
                                        ...
                                        <td style="padding: 8px">
                                            ...
                                            <?php if ($item->product_slug === 'home-insurance') : ?>
                                                <a href="<?= base_url() ?>/load-home/<?= $item->product_slug; ?>">
                                                    <h4 class="mb-3"><?= ucfirst($item['product_name']); ?></h4>
                                                </a>
                                        ...
                                        <td style="padding:8px" class="text-center">
                                            ...
                                            <div class="mt10">
                                                <a class="btn-link" id="example-one" data-text-swap="Hide Details" data-text-original="Expand Details" data-toggle="collapse" href="#collapseExample<?= $item->_id; ?>" aria-expanded="false" aria-controls="collapseExample<?= $item->_id; ?>">
