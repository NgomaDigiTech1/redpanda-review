                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                ...
                                                >
                                                    ...
                                                    <div class="fee-charges-table">
                                                        <ul class="list-group">
                                                            <?php foreach ($product_det->caracteristics as $key => $val): ?>
                                                                <?php if(($key !== 'product_id') && ($key !== 'conditions_content') && ($val != null)) :?>
                                                ...
                                                >
                                                    ...
                                                    <ul class="listnone bullet bullet-check-circle-default">
                                                        <?php
                                                            $sectors = (new App\Controllers\Products)->getSectorsProduct($produit->_id);
