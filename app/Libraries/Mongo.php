...
class Mongo
{
    ...
    public function myDistinct($collection, $field){
        return $this->m->selectCollection($this->mongoConnectionInfos->db, $this->mongoConnectionInfos->prefix . $collection)->distinct($field);
    }
}
